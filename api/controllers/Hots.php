<?php
	...
	class Hots extends CommonController {
		public function get() {

			$this->json['page']['items'] = \tools\Hot::getList();

			$res = \CIBlockElement::GetProperty(\Config::IBLOCK_ID_CONTENT, \Config::ID_HOTS, array("SORT" => "ASC"), array("CODE" => "SLIDER"));
			...
			$res = \CIBlockElement::GetList(array(),['IBLOCK_ID' => \Config::IBLOCK_ID_CONTENT,'ID' => \Config::ID_HOTS,'ACTIVE' => 'Y',],
				false,
				false,
