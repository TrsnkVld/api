<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . "/../api/tools/Claim.php";

	class Claims extends CommonController {
		public function get() {
			$this->json['page']['items'] = \tools\Claim::getList();

			$res = \CIBlockElement::GetList(array(),['IBLOCK_ID' => \Config::IBLOCK_ID_CONTENT,'ID' => \Config::ID_CLAIMS,'ACTIVE' => 'Y',],
				false,
				false,
            ...
            $res = \CIBlockElement::GetProperty(\Config::IBLOCK_ID_CONTENT, \Config::ID_CLAIMS, array("SORT" => "ASC"), array("CODE" => "SLIDER"));
